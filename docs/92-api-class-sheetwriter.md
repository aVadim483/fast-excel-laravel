...
* [exportModel()](#exportmodel) -- Export a model to the sheet
* [formatAttributes()](#formatattributes) -- Set format attributes
...
* [writeData()](#writedata) -- Write data to the sheet
...
```php
public function addCellStyle(string $cellAddr, 
                             $style): avadim\FastExcelWriter\Sheet
```
...
public function addChart(string $range, 
                         avadim\FastExcelWriter\Charts\Chart $chart): avadim\FastExcelWriter\Sheet
```
...
```php
public function addConditionalFormatting(string $range, 
                                         $conditionals): avadim\FastExcelWriter\Sheet
```
...
public function addDataValidation(string $range, 
                                  avadim\FastExcelWriter\DataValidation\DataValidation $validation): avadim\FastExcelWriter\Sheet
```
...
public function addImage(string $cell, string $imageFile, 
                         ?array $imageStyle = []): avadim\FastExcelWriter\Sheet
```
...
public function addNamedRange(string $range, 
                              string $name): avadim\FastExcelWriter\Sheet
```
...
```php
public function addNote($cell, $comment, 
                        array $noteStyle = []): avadim\FastExcelWriter\Sheet
```
...
```php
public function addStyle(string $cellAddr, 
                         $style): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowAutoFilter(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowDeleteColumns(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowDeleteRows(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowEditObjects(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowEditScenarios(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowFormatCells(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowFormatColumns(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowFormatRows(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowInsertColumns(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowInsertHyperlinks(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowInsertRows(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowPivotTables(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowSelectCells(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowSelectLockedCells(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowSelectUnlockedCells(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function allowSort(?bool $allow = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyAlignLeft(): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyAlignRight(): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyBgColor(string $color, 
                             ?string $pattern = null): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyBorder(string $style, 
                            ?string $color = '#000000'): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyColor(string $color): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyConditionalFormatting($conditionals): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyDataValidation(avadim\FastExcelWriter\DataValidation\DataValidation $validation): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFillColor(string $color, 
                               ?string $pattern = null): avadim\FastExcelWriter\Sheet
```
...
public function applyFillGradient(string $color1, string $color2, 
                                  ?int $degree = null): avadim\FastExcelWriter\Sheet
```
...
public function applyFont(string $fontName, ?int $fontSize = null, 
                          ...
                          ?string $fontColor = null): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontColor(string $fontColor): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontName(string $fontName): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontSize(float $fontSize): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontStyle(string $fontStyle): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontStyleBold(): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontStyleItalic(): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontStyleStrikethrough(): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFontStyleUnderline(?bool $double = false): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyFormat($format): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyHide(?bool $hide = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyIndentDistributed(int $indent): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyIndentLeft(int $indent): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyIndentRight(int $indent): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyNamedRange(string $name): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyRowHeight(float $height): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyRowOutlineLevel(int $outlineLevel): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyStyle($style): avadim\FastExcelWriter\Sheet
```
_Apply the style_
...
public function applyTextAlign(string $textAlign, 
                               ?string $verticalAlign = null): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyTextCenter(): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyTextColor(string $color): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyTextRotation(int $degrees): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyTextWrap(?bool $textWrap = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyUnlock(?bool $unlock = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function applyVerticalAlign(string $verticalAlign): avadim\FastExcelWriter\Sheet
```
...
```php
public function beginArea(?string $cellAddress = null): avadim\FastExcelWriter\Area
```
_Begin a new area_
...
```php
public function beginOutlineLevel(?bool $collapsed = false): avadim\FastExcelWriter\Sheet
```
...
```php
public function cell($cellAddress): avadim\FastExcelWriter\Sheet
```
...
```php
public function clearAreas(): avadim\FastExcelWriter\Sheet
```
...
```php
public function endAreas(): avadim\FastExcelWriter\Sheet
```
...
```php
public function endOutlineLevel(): avadim\FastExcelWriter\Sheet
```
...
```php
public function makeArea(string $range): avadim\FastExcelWriter\Area
```
...
public function mergeCells($rangeSet, 
                           ?int $mergeFlag = 0): avadim\FastExcelWriter\Sheet
```
_Merge cells_
...
```php
public function mergeRelCells($rangeSet): avadim\FastExcelWriter\Sheet
```
...
```php
public function nextCell(): avadim\FastExcelWriter\Sheet
```
...
```php
public function nextRow($style, 
                        ?bool $forceRow = false): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageFitToHeight($numPage): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageFitToWidth($numPage): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageFooter($footer): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageFooterEven($footer): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageFooterFirst($footer): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageFooterOdd(string $footer): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageHeader($header): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageHeaderEven($header): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageHeaderFirst($header): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageHeaderFooter(?string $header, 
                                 ?string $footer): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageHeaderOdd($header): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageLandscape(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageMarginBottom($value): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageMarginFooter($value): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageMarginHeader($value): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageMarginLeft($value): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageMarginRight($value): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageMargins(array $margins): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageMarginTop($value): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageOrientationLandscape(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageOrientationPortrait(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePaperHeight($paperHeight): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePaperSize(int $paperSize): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePaperSizeA3(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePaperSizeA4(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePaperSizeLegal(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePaperSizeLetter(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePaperWidth($paperWidth): avadim\FastExcelWriter\Sheet
```
...
```php
public function pagePortrait(): avadim\FastExcelWriter\Sheet
```
...
```php
public function pageScale(int $scale): avadim\FastExcelWriter\Sheet
```
_Set page scale_
...
```php
public function protect(?string $password = null): avadim\FastExcelWriter\Sheet
```
_Protect sheet_
...
```php
public function setActiveCell($cellAddress): avadim\FastExcelWriter\Sheet
```
_Set active cell_
...
```php
public function setAutoFilter($rowOrCell, 
                              ?int $col = 1): avadim\FastExcelWriter\Sheet
```
_Set auto filter_
...
```php
public function setBgColor(string $cellAddr, 
                           string $color): avadim\FastExcelWriter\Sheet
```
...
```php
public function setBottomNodesOptions(string $node, 
                                      array $options): avadim\FastExcelWriter\Sheet
```
...
public function setCellStyle(string $cellAddress, $style, 
                             ?bool $mergeStyles = false): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColAutoWidth($col): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColDataStyle($colRange, 
                                $colStyle): avadim\FastExcelWriter\Sheet
```
_Set styles of column cells (colors, formats, etc.)Styles are applied only to non-empty cells in a column and only take effect starting with the current row_
...
```php
public function setColDataStyleArray(array $colStyles): avadim\FastExcelWriter\Sheet
```
_Set style of column cells (colors, formats, etc.)Styles are applied only to non-empty cells in a column and only take effect starting with the current row_
...
```php
public function setColFormat($col, $format): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColFormats(array $formats): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColFormula($col, 
                              string $formula): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColHidden($col): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColMinWidth($col, $width): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColMinWidths(array $widths): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColOutlineLevel($col, 
                                   int $outlineLevel): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColStyle($colRange, $style): avadim\FastExcelWriter\Sheet
```
_Set style of single or multiple column(s)Styles are applied to the entire sheet column(s) (even if it is empty)_
...
```php
public function setColStyleArray($colStyles): avadim\FastExcelWriter\Sheet
```
_Set styles of single or multiple column(s)Styles are applied to the entire sheet column(s) (even if it is empty)_
...
```php
public function setColVisible($col, bool $val): avadim\FastExcelWriter\Sheet
```
...
public function setColWidth($col, $width, 
                            ?bool $min = false): avadim\FastExcelWriter\Sheet
```
...
```php
public function setColWidthAuto($col): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFont($font): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontColor(string $fontColor): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontName(string $fontName): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontSize(int $fontSize): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontStyle(string $fontStyle): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontStyleBold(): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontStyleItalic(): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontStyleStrikethrough(): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultFontStyleUnderline(?bool $double = false): avadim\FastExcelWriter\Sheet
```
...
```php
public function setDefaultStyle($style): avadim\FastExcelWriter\Sheet
```
...
```php
public function setFormat(string $cellAddr, 
                          string $format): avadim\FastExcelWriter\Sheet
```
...
```php
public function setFormula($cellAddress, $value, 
                           $style): avadim\FastExcelWriter\Sheet
```
...
```php
public function setFreeze($freezeRows, 
                          $freezeColumns): avadim\FastExcelWriter\Sheet
```
...
```php
public function setFreezeColumns(int $freezeColumns): avadim\FastExcelWriter\Sheet
```
_Freeze columns_
...
```php
public function setFreezeRows(int $freezeRows): avadim\FastExcelWriter\Sheet
```
_Freeze rows_
...
```php
public function setName(string $sheetName): avadim\FastExcelWriter\Sheet
```
_Set sheet name_
...
```php
public function setOuterBorder(string $range, 
                               $style): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintArea(string $range): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintCentered(?bool $value = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintGridlines(?bool $bool = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintHorizontalCentered(?bool $value = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintLeftColumns(string $range): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintRowAndColumnHeading(?bool $bool = true): avadim\FastExcelWriter\Sheet
```
...
public function setPrintTitles(?string $rowsAtTop, 
                               ?string $colsAtLeft = null): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintTopRows(string $range): avadim\FastExcelWriter\Sheet
```
...
```php
public function setPrintVerticalCentered(?bool $value = true): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowDataStyle($rowRange, 
                                $style): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowDataStyleArray(array $rowStyles): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowHeight($rowNum, $height): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowHeights(array $heights): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowHidden($rowNum): avadim\FastExcelWriter\Sheet
```
...
public function setRowOutlineLevel($rowNum, int $outlineLevel, 
                                   ?bool $collapsed = null): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowStyle($rowRange, $style): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowStyleArray(array $rowStyles): avadim\FastExcelWriter\Sheet
```
...
```php
public function setRowVisible($rowNum, 
                              bool $visible): avadim\FastExcelWriter\Sheet
```
...
```php
public function setStateHidden(): avadim\FastExcelWriter\Sheet
```
...
```php
public function setStateVeryHidden(): avadim\FastExcelWriter\Sheet
```
...
```php
public function setStateVisible(): avadim\FastExcelWriter\Sheet
```
...
```php
public function setTabColor(?string $color): avadim\FastExcelWriter\Sheet
```
...
```php
public function setTopLeftCell($cellAddress): avadim\FastExcelWriter\Sheet
```
...
```php
public function setValue($cellAddress, $value, 
                         $style): avadim\FastExcelWriter\Sheet
```
...
```php
public function skipRow(?int $rowCount = 1): avadim\FastExcelWriter\Sheet
```
_Skip rows_
...
```php
public function unprotect(): avadim\FastExcelWriter\Sheet
```
_Unprotect sheet_
...
```php
public function withHeadings(?array $headers = [], ?array $rowStyle = [], 
                             ?array $colStyles = []): SheetWriter
```
...
```php
public function withLastCell(): avadim\FastExcelWriter\Sheet
```
...
```php
public function withLastRow(): avadim\FastExcelWriter\Sheet
```
...
```php
public function withRange($range): avadim\FastExcelWriter\Sheet
```
...
public function writeArray(array $rowArray = [], 
                           $rowStyle): avadim\FastExcelWriter\Sheet
```
...
```php
public function writeArrayTo($topLeftCell, 
                             array $data): avadim\FastExcelWriter\Sheet
```
...
public function writeCell($value, 
                          ?array $styles = null): avadim\FastExcelWriter\Sheet
```
...
```php
public function writeCells(array $values, 
                           ?array $cellStyles = null): avadim\FastExcelWriter\Sheet
```
...
public function writeHeader(array $header, ?array $rowStyle = null, 
                            ?array $colStyles = []): avadim\FastExcelWriter\Sheet
```
...
public function writeRow(array $rowValues = [], $rowStyle, 
                         ?array $cellStyles = null): SheetWriter
```
...
public function writeRows(array $rowArray = [], 
                          ?array $rowStyle = null): avadim\FastExcelWriter\Sheet
```
